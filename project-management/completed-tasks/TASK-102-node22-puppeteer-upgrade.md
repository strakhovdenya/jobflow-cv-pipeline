...
- [x] CI's `Dependabot Severity Gate` job passes on this branch. Confirmed on PR #188 — all 13 CI
      checks green, including `Dependabot Severity Gate` (the exact check that was blocking
      TASK-100's PR #187).
