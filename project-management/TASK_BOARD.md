...
**TASK-075** (Component: PipelineStages) and **TASK-076** (Component: WorkspaceStatusHeader), the
epic's first two implementation sub-tasks, are now DONE (2026-07-26) — see
`project-management/completed-tasks/TASK-075-pipeline-stages.md`,
`project-management/completed-tasks/TASK-076-workspace-status-header.md` and the 2026-07-26
`TEST_LOG.md` entries. Recommended next: **TASK-077** (Component: MainActionCard), on a new branch
