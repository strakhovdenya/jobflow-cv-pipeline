...
**TASK-075** (Component: PipelineStages), the epic's first implementation sub-task, is now DONE
(2026-07-26) — see `project-management/completed-tasks/TASK-075-pipeline-stages.md` and the
2026-07-26 `TEST_LOG.md` entry. Recommended next: **TASK-076** (Component: WorkspaceStatusHeader),
on a new branch off the same epic base branch `task/TASK-073-redesign-base` — awaiting explicit
user selection before starting.
