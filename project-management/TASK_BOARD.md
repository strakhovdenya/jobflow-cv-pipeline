...
| TASK-064 | Phase 15 — Full Pipeline Control UI | Add artifact content viewer and generic download links | DONE | P2 | see docs/07_task_backlog.md | branch task/TASK-064-artifact-content-viewer | New Next.js Route Handler proxy for authenticated download/view; ArtifactViewer component |
