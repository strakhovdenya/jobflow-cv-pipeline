...
Recommended next task: **TASK-PH-009** (Reapply rate limiting onto current main), first of four `Phase PH-2 — Production Hardening Follow-ups` tasks added 2026-07-13 from a user-driven audit; inserted ahead of TASK-044 (see `docs/07_task_backlog.md` §17.2). Recommended order within PH-2: PH-009 → PH-010 → PH-011 → PH-012. Phase 8 (TASK-044) resumes after PH-2 is done.
Current phase: `Phase PH-2 — Production Hardening Follow-ups` (TASK-PH-009..012, all TODO) inserted ahead of the remainder of `Phase 8 — P1 Safety & Quality Layer` (TASK-044).
...
| TASK-PH-003 | Phase PH — Production Hardening (Quick Wins) | Add rate limiting (@nestjs/throttler) | BLOCKED | P0 | TASK-PH-001 | branch task/TASK-PH-003-rate-limiting (unmerged, stale) | Was marked DONE in error — implementation exists only on an orphaned branch forked before Swagger/Pino/OpenAI/Puppeteer/husky were added, never merged into main. main has no @nestjs/throttler today. Superseded by TASK-PH-009, found during 2026-07-13 audit. |
...
| TASK-PH-009 | Phase PH-2 — Production Hardening Follow-ups | Reapply rate limiting (@nestjs/throttler) onto current main | TODO | P0 | TASK-PH-001 | see docs/07_task_backlog.md §17.2 | Supersedes the orphaned TASK-PH-003 branch; also corrects TASK_BOARD.md |
| TASK-PH-010 | Phase PH-2 — Production Hardening Follow-ups | Add security governance files (SECURITY.md, Dependabot, CodeQL) | TODO | P1 | — | see docs/07_task_backlog.md §17.2 | No source code changes; GitHub config only |
